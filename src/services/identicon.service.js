...
class IdenticonGenerator {
    /**
     * @param {string} input The string to hash for generating the identicon.
     * @param {object} options Configuration options.
     * @param {number} [options.size=250] The width and height of the final image in pixels.
     * @param {string} [options.hashAlgorithm='md5'] The hashing algorithm to use (e.g., 'md5', 'sha256').
     * @param {object} [options.backgroundColor={ r: 240, g: 240, b: 240, alpha: 1 }] The background color.
     */
